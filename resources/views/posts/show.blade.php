                        ...
                        <form action="/posts/{{$post->slug}}/comments" method="post">
                            ...
                            <div class="mt-6">
                                <textarea 
                                    ...
                                    rows="5" 
                                    placeholder="Quick, thing of something to speak!"></textarea>
                            </div>

                            <div class="flex justify-end pt-6 mt-6 border-t border-gray-200 ">
                                <button class="bg-blue-500 text-white text-xs py-2 px-10 uppercase text-semibold rounded-2xl hover:bg-blue-600">Post</button>
                            </div>
                        </form>
                    </x-panel>
